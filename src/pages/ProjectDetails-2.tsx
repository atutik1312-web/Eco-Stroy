            ...
            <table className="w-full text-left border-collapse min-w-[800px]">
              <thead>
                <tr className="bg-primary text-slate-900">
                  ...
                  <th className="p-4 font-bold text-lg border-b border-r border-black/10 text-center">{formatPrice(project.price)}</th>
                  <th className="p-4 font-bold text-lg border-b border-black/10 text-center">{formatPrice(project.price * 1.3)}</th>
                </tr>
                <tr className="bg-slate-50 dark:bg-slate-900">
                  <th className="p-4 font-bold text-slate-900 dark:text-white border-b border-r border-slate-200 dark:border-slate-800">Фундамент</th>
              ...
              <tbody className="bg-white dark:bg-slate-950">
                {[
                  ...
                  <tr key={i} className="border-b border-slate-100 dark:border-slate-800 hover:bg-slate-50 dark:hover:bg-slate-900/50 transition-colors">
                ...
                <tr className="bg-slate-50 dark:bg-slate-900">
                  <th colSpan={3} className="p-4 font-bold text-slate-900 dark:text-white border-b border-slate-200 dark:border-slate-800">Цокольное перекрытие</th>
                </tr>
                {[
                  ...
                  { name: 'Финишное покрытие - фанера 21мм', v1: false, v2: true },
                ].map((row, i) => (
                  <tr key={i} className="border-b border-slate-100 dark:border-slate-800 hover:bg-slate-50 dark:hover:bg-slate-900/50 transition-colors">
                    <td className="p-4 text-sm text-slate-700 dark:text-slate-300 border-r border-slate-100 dark:border-slate-800">{row.name}</td>
                    <td className="p-4 text-center border-r border-slate-100 dark:border-slate-800">
                ...
                <tr className="bg-slate-50 dark:bg-slate-900">
                  <th colSpan={3} className="p-4 font-bold text-slate-900 dark:text-white border-b border-slate-200 dark:border-slate-800">Несущие стены</th>
                </tr>
                {[
                  { name: 'Каркас внешних стен - 35х140мм камерной сушки', v1: true, v2: true },
                  ...
                  { name: 'Внутренняя отделка - имитация бруса', v1: false, v2: true },
                ].map((row, i) => (
                  <tr key={i} className="border-b border-slate-100 dark:border-slate-800 hover:bg-slate-50 dark:hover:bg-slate-900/50 transition-colors">
                    <td className="p-4 text-sm text-slate-700 dark:text-slate-300 border-r border-slate-100 dark:border-slate-800">{row.name}</td>
                    <td className="p-4 text-center border-r border-slate-100 dark:border-slate-800">
