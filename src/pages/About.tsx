        ...
        <section className="flex flex-col lg:flex-row gap-10 items-center">
          <div className="flex-1 flex flex-col gap-6">
            ...
            <p className="text-lg text-slate-600 dark:text-slate-400 leading-relaxed">
              Мы — команда увлеченных строителей, объединенных одной целью: создавать экологичные, долговечные и красивые деревянные дома. С начала 2003 года мы воплощаем мечты наших заказчиков в комфортное и уютное жилье.
            </p>
            <p className="text-lg text-slate-600 dark:text-slate-400 leading-relaxed">
