      ...
      <div className="w-full max-w-7xl flex flex-col gap-16">
        ...
        <section className="flex flex-col lg:flex-row gap-10 items-center">
          <div className="flex-1 flex flex-col gap-6">
            ...
            <p className="text-lg text-slate-600 dark:text-slate-400 leading-relaxed">
              Мы — команда увлеченных профессионалов, объединенных одной целью: создавать экологичные, долговечные и красивые деревянные дома. С 2011 года мы воплощаем мечты семей о собственном уютном уголке природы.
            </p>
            <p className="text-lg text-slate-600 dark:text-slate-400 leading-relaxed">
              Наша миссия — сделать загородную жизнь комфортной и доступной, сохраняя при этом бережное отношение к окружающей среде.
            </p>
          </div>
        ...
        <section className="grid grid-cols-2 md:grid-cols-4 gap-6">
          <div className="bg-white dark:bg-slate-900 p-8 rounded-2xl text-center border border-slate-100 dark:border-slate-800 shadow-sm">
            <span className="text-4xl md:text-5xl font-black text-primary block mb-2">12+</span>
            <span className="text-slate-600 dark:text-slate-400 font-medium">Лет на рынке</span>
          </div>
          <div className="bg-white dark:bg-slate-900 p-8 rounded-2xl text-center border border-slate-100 dark:border-slate-800 shadow-sm">
            <span className="text-4xl md:text-5xl font-black text-primary block mb-2">450+</span>
            <span className="text-slate-600 dark:text-slate-400 font-medium">Сданных объектов</span>
          </div>
          <div className="bg-white dark:bg-slate-900 p-8 rounded-2xl text-center border border-slate-100 dark:border-slate-800 shadow-sm">
            <span className="text-4xl md:text-5xl font-black text-primary block mb-2">150</span>
            <span className="text-slate-600 dark:text-slate-400 font-medium">Специалистов</span>
          </div>
          <div className="bg-white dark:bg-slate-900 p-8 rounded-2xl text-center border border-slate-100 dark:border-slate-800 shadow-sm">
            <span className="text-4xl md:text-5xl font-black text-primary block mb-2">50</span>
        ...
        <section className="flex flex-col gap-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { name: 'Александр Иванов', role: 'Главный архитектор', img: 'https://picsum.photos/seed/alex/400/500' },
              { name: 'Елена Смирнова', role: 'Руководитель проектов', img: 'https://picsum.photos/seed/elena/400/500' },
              { name: 'Михаил Волков', role: 'Главный инженер', img: 'https://picsum.photos/seed/mikhail/400/500' },
              { name: 'Дмитрий Соколов', role: 'Прораб', img: 'https://picsum.photos/seed/dmitry/400/500' },
            ].map((member, i) => (
