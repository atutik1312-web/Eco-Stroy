                ...
                <div className="grid grid-cols-2 gap-y-4 gap-x-4 text-sm">
                  <div className="flex items-center gap-2 text-slate-600 dark:text-slate-400">
                    ...
                    <div className="flex flex-col min-w-0">
                      ...
                      <span className="truncate font-medium text-slate-900 dark:text-white leading-none">{project.area}</span>
                    </div>
                  </div>
                  {project.houseSize && (
                    <div className="flex items-center gap-2 text-slate-600 dark:text-slate-400">
                      ...
                      <div className="flex flex-col min-w-0">
                        ...
                        <span className="truncate font-medium text-slate-900 dark:text-white leading-none">{project.houseSize}</span>
                      </div>
                    </div>
                  )}
                  <div className="flex items-center gap-2 text-slate-600 dark:text-slate-400">
                    <span className="material-symbols-outlined text-[20px] text-primary shrink-0">layers</span>
                    <div className="flex flex-col min-w-0">
                      <span className="text-xs text-slate-500 leading-none mb-1">Этажность</span>
                      <span className="truncate font-medium text-slate-900 dark:text-white leading-none">{project.floors}</span>
                    </div>
                  </div>
                  <div className="flex items-center gap-2 text-slate-600 dark:text-slate-400">
                    <span className="material-symbols-outlined text-[20px] text-primary shrink-0">bed</span>
                    <div className="flex flex-col min-w-0">
                      <span className="text-xs text-slate-500 leading-none mb-1">Спальни</span>
                      <span className="truncate font-medium text-slate-900 dark:text-white leading-none">{project.bedrooms}</span>
                    </div>
                  </div>
                  {project.bathrooms && (
                    <div className="flex items-center gap-2 text-slate-600 dark:text-slate-400">
                      <span className="material-symbols-outlined text-[20px] text-primary shrink-0">bathtub</span>
                      <div className="flex flex-col min-w-0">
                        <span className="text-xs text-slate-500 leading-none mb-1">Санузлы</span>
                        <span className="truncate font-medium text-slate-900 dark:text-white leading-none">{project.bathrooms}</span>
                      </div>
                    </div>
                  )}
                  <div className="flex items-center gap-2 text-slate-600 dark:text-slate-400">
                    ...
                    <div className="flex flex-col min-w-0">
                      ...
                      <span className="truncate font-medium text-slate-900 dark:text-white leading-none">{project.time}</span>
                    </div>
                  </div>
                </div>
